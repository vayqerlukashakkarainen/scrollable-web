...
import { n as noop$1, s as safe_not_equal, r as onMount, v as tick } from "./Cgb4ZbU3.js";
import { a as assets, b as base } from "./BVxC8YUZ.js";
...
async function start(_app, _target, hydrate) {
  ...
  app = _app;
  await ((_b = (_a = _app.hooks).init) == null ? void 0 : _b.call(_a));
  routes = parse(_app);
  ...
  current_history_index = (_c = history.state) == null ? void 0 : _c[HISTORY_INDEX];
  current_navigation_index = (_d = history.state) == null ? void 0 : _d[NAVIGATION_INDEX];
...
async function _preload_code(url) {
  var _a;
  const route = (_a = await get_navigation_intent(url, false)) == null ? void 0 : _a.route;
  if (route) {
